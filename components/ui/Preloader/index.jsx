...
import ic_import from '../../../public/images/jelo.png';

import { Wrapper, Inner, SecondOverlay } from '../Preloader/style';
...
const Preloader = ({ setComplete }) => {
  ...
  const spans = useRef([]); // Create a ref to store the span elements
